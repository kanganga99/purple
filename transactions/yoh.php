...
/* 
                                ...
                                <form action="" method="post">
                                    <div id="printThis">
                                        <div class="modal fade" id="edit_Modal2<?php echo $row['id'] ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="container-fluid">
                                                            ...
                                                            <div class="flex">
                                                                <div class="w-50">
                                                                    <p><b>Student name:</b> <?php echo isset($row['student_name']) ? $row['student_name'] : '' ?></p>
                                                                    <p><b>Student ID:</b> <?php echo isset($row['student_id']) ? $row['student_id'] : '' ?></p>
                                                                    <p><b>Class name:</b> <?php echo isset($row['class_name']) ? $row['class_name'] : '' ?></p>
                                                                </div>
                                                                <div class="w-50">
                                                                            ...
                                                                            <table width="100%">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class='text-right'><b>
                                                                                            ...
                                                                                            echo $totalPaidAmount ?></b></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>Balance</td>
                                                                                    <td class='text-right'><b><?php echo ($totalFeeAmount - $totalPaidAmount) ?></b></td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                                                    </tr>
