            ...
            <div class="row">
                <div class="card mb-4">
                    ...
                    <table class="table  tb" id="transactions">
                        ...
                        <tbody>
                            <?php
                            $query = "SELECT * FROM transactions WHERE companyid='$companyid'";
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                $query4 = "SELECT CONCAT(`classname`,' ', `level`) AS classname FROM `classes`";
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a data-bs-toggle="modal" data-bs-target="#edit_Modal2<?php echo $row['id'] ?>"><i class="mdi mdi-eye-outline"></i></a>
                                                ...
                                                <div class="modal-dialog" style="max-width: 50%;">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            ...
                                                            <button type="button" id="Print" class="btn btn-success center">Print</button>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                                    ...
                                                                    <tr>
                                                                        <td width="50%">
                                                                            ...
                                                                            <table class="wborder" style="width: 100%;">
                                                                                <tr>
                                                                                    <td style="width: 100%;">Fee Type</td>
                                                                                    <td style="width: 100%;" class="text-right">Amount</td>
                                                                                </tr>
                                                                                <?php
                                                                                $totalFeeAmount = 0;
                                                                        ...
                                                                        <td width="50%">
                                                                            ...
                                                                            <!-- <table>
                                                                                <tr>
                                                                                    <td>Total Fee</td>
                                                                                    <td class="text-right"><b></?php echo $totalFee ?></b></td> 
                                                                                </tr>
                                                                            </table> -->
                                                                        </td>
                                                                    </tr>
