          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td>
                  <a href="edit_student.php?id=<?php echo $row['id'] ?>" class="link-dark"><i class="mdi mdi-pencil"></i></a>
                  <a href="viewall.php?id=<?php echo $row['id'] ?>" class="link-dark"><i class="mdi mdi-eye-outline "></i></a>
